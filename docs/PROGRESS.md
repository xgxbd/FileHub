...
## 2026-03-12 09:20:31 CST

- 任务：v0.3.0 交付文档最终收口
- 时间：2026-03-12 09:20:31 CST
- git 版本：git version 2.50.1 (Apple Git-155)
- git 分支及 Commit ID：hotfix/v0.3.0-doc-closure / 待提交
- 本次修改：
  - 更新 `README.md`，明确 `v0.3.0` 已正式交付并将 Docker 作为推荐启动方式
  - 更新 `docs/RELEASE_CHECKLIST.md`，补充 `v0.3.0` 发布执行结果
  - 更新 `docs/SETUP.md`，明确当前正式交付版本与推荐启动口径
- 已完成事项：
  - 对外交付入口文档已统一到 `v0.3.0` 口径
  - 发布清单已从模板状态收口到实际执行结果
- 未完成事项：
  - 将文档收口热修分支合并回 `main` 与 `develop`
- 当前可测试内容：
  - 查看 `README.md`
  - 查看 `docs/RELEASE_CHECKLIST.md`
  - 查看 `docs/SETUP.md`
- 风险说明：
